...
router.delete("/consultations/:id/reply/:replyId", async (req, res) => {
    try {
        const reply = await prisma_1.prisma.consultation.findUnique({
...
router.delete("/consultations/:id", async (req, res) => {
    try {
        ...
        await prisma_1.prisma.consultation.deleteMany({
