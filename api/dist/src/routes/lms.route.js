...
const lms_guard_1 = require("../middleware/lms-guard");
...
router.use(lms_guard_1.authorizeLMS);
// FILTER DATA
...
router.post("/materials/upload", multer_1.uploadMaterial.single("file"), lmsController.uploadMaterialFile);
...
//# sourceMappingURL=lms.route.js.map